...
urlpatterns = [
    ...
    path("profile/account/", views.admin_account_info, name="account_info"),
    ...
    path("profile/preferences/", views.admin_preferences, name="preferences"),
    path("notifications/me/", views.my_notifications, name="my_notifications"),
    # Students
